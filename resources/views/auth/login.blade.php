        ...
        <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                ...
                <a href="{{ route('password.request') }}" class="font-medium text-green-600 hover:text-green-500"> {{ __('Forgot your password?') }} </a>
                @endif
              </div>
            </div>
